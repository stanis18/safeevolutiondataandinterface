...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    function getAnchor(uint256 _index) public view  returns (IConverterAnchor) {
    ...
    */
    function getLiquidityPool(uint256 _index) public view  returns (IConverterAnchor) {
    ...
    */
    function getConvertibleToken(uint256 _index) public view  returns (IERC20Token) {
    ...
    */
    function getConvertibleTokenAnchorCount(IERC20Token _convertibleToken) public view  returns (uint256) {
    ...
    */
    function getConvertibleTokenAnchors(IERC20Token _convertibleToken) public view  returns (address[] memory) {
    ...
    */
    function getConvertibleTokenAnchor(IERC20Token _convertibleToken, uint256 _index) public view  returns (IConverterAnchor) {
    ...
    */
    function isConvertibleTokenAnchor(IERC20Token _convertibleToken, address _value) public view  returns (bool) {

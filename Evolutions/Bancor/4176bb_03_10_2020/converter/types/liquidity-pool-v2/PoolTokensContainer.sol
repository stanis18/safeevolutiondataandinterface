...
contract PoolTokensContainer is IPoolTokensContainer, Owned, TokenHolder {
    ...
    */
    function createToken() external  ownerOnly returns (ISmartToken) {
    ...
    */
    function mint(ISmartToken _token, address _to, uint256 _amount) external  ownerOnly {
    ...
    */
    function burn(ISmartToken _token, address _from, uint256 _amount) external  ownerOnly {

...
// _ownedTokensCount = nw._ownedTokensCount -> od._ownedTokensCount
...
contract Refinement {
    ...
    /// @notice precondition  od._ownedTokensCount[owner] == nw._ownedTokensCount[owner] && od._ownedTokensCount[owner] == _balance_
    /// @notice postcondition nw._ownedTokensCount[owner] == _balance_
